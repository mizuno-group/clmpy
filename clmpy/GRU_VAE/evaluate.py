...
from ..data_handler import tokens_table
from ..preprocess import prep_valid_data

DEVICE = "cuda" if torch.cuda.is_available() else "cpu"

class Evaluator():
    def __init__(self,model,args):
        self.id2sm = tokens_table(args.token_path).id2sm
...
def main(args):
    ...
    results, accuracy = evaluator.evaluate(test_loader)
